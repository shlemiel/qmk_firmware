...
[0] = LAYOUT_planck_grid(
     ...
     MO(3)   , UK_M0   , UK_M1   , KC_LCTL , MO(1)   , KC_SPC  , KC_NO   , MO(2)   , KC_LALT , KC_LGUI , KC_RALT , KC_RCTL
),
...
[2] = LAYOUT_planck_grid(
     ...
     KC_INS  , KC_F1   , KC_F2   , KC_F3   , KC_F4   , KC_HOME , KC_END  , KC_UNDS , KC_PLUS , KC_LCBR , KC_RCBR , KC_PIPE ,
...
[3] = LAYOUT_planck_grid(
     KC_NO   , KC_NO   , KC_NO   , KC_NO   , KC_NO   , KC_NO   , KC_NO   , KC_NO   , KC_NO   , KC_NO   , KC_BTN4 , KC_BTN5 ,
     KC_NO   , KC_NO   , KC_NO   , KC_NO   , KC_NO   , KC_NO   , KC_MS_L , KC_MS_D , KC_MS_U , KC_MS_R , KC_BTN1 , KC_BTN2 ,
