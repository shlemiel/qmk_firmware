...
[L0] = LAYOUT_planck_grid(
    ...
    MO(L1)  , KC_NO   , KC_NO   , KC_LCTL , MO(L2) , KC_SPC , KC_SPC , MO(L3) , KC_LGUI , KC_LALT , KC_NO   , KC_NO  
),
...
[L1] = LAYOUT_planck_grid(
    ...
    KC_TRNS , KC_RCTL , KC_RALT , KC_NO   , KC_ACL2 , KC_NO   , KC_NO   , KC_TRNS , KC_LEFT , KC_DOWN , KC_UP   , KC_RGHT
),
...
[L5] = LAYOUT_planck_grid(
    ...
    KC_NO   , KC_BTN1 , KC_BTN2 , KC_BTN3 , KC_BTN4 , KC_BTN5 , KC_MS_L , KC_MS_D , KC_MS_U , KC_MS_R , KC_NO   , KC_NO   ,
    KC_LSFT , KC_WH_L , KC_WH_D , KC_WH_U , KC_WH_R , KC_NO   , KC_NO   , KC_NO   , KC_NO   , KC_NO   , KC_NO   , KC_NO   ,
    KC_TRNS , KC_RCTL , KC_RALT , KC_NO   , KC_ACL2 , KC_NO   , KC_NO   , KC_TRNS , KC_HOME , KC_PGDN , KC_PGUP , KC_END
),
