...
[L0] = LAYOUT_planck_grid(
     ...
     MO(L3)  , KC_NO   , KC_NO   , KC_LCTL , MO(L1)  , KC_SPC  , KC_SPC  , MO(L2)  , KC_LGUI , KC_LALT , KC_RALT , KC_RCTL
),
...
[L3] = LAYOUT_planck_grid(
     KC_NO   , KC_LEFT , KC_DOWN , KC_UP   , KC_RGHT , KC_NO   , KC_NO   , KC_NO   , KC_NO   , KC_NO   , KC_NO   , KC_NO   ,
...
[L4] = LAYOUT_planck_grid(
     KC_NO   , KC_HOME , KC_PGDN , KC_PGUP , KC_END  , KC_NO   , KC_NO   , KC_NO   , KC_NO   , KC_PSCR , KC_APP  , KC_PAUS ,
