...
[_QWERTY] = LAYOUT_planck_grid(
    ...
    MO(_COLEMAK), KC_LCTL, KC_LGUI, KC_LALT, LOWER, KC_SPC, KC_SPC, RAISE, KC_LEFT, KC_DOWN, KC_UP, KC_RGHT
),
...
[_COLEMAK] = LAYOUT_planck_grid(
    ...
    KC_NO, KC_BTN1, KC_BTN2, KC_BTN3, KC_WH_U, KC_NO, KC_NO, KC_MS_L, KC_MS_D, KC_MS_R, KC_NO, KC_NO,
    KC_LSFT, KC_NO, KC_NO, KC_WH_L, KC_WH_D, KC_WH_R, KC_NO, KC_NO, KC_NO, KC_NO, KC_NO, KC_NO,
    KC_TRNS, KC_RCTL, KC_LGUI, KC_RALT, KC_NO, KC_NO, KC_NO, KC_NO, KC_LALT, KC_LGUI, KC_LCTL, KC_NO
),
