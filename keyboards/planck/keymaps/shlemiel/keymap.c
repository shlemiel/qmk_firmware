...
[1] = LAYOUT_planck_grid(
     ...
     KC_TAB  , KC_DEL  , KC_NO   , KC_NO   , KC_INS  , KC_LEFT , KC_RGHT , KC_MINS , KC_EQL  , KC_LBRC , KC_RBRC , KC_BSLS ,
     KC_TRNS , KC_APP  , KC_PSCR , KC_NO   , KC_PAUS , KC_DOWN , KC_UP   , KC_NO   , KC_NO   , KC_NO   , KC_NO   , KC_TRNS ,
...
[2] = LAYOUT_planck_grid(
     ...
     KC_TAB  , KC_F1   , KC_F2   , KC_F3   , KC_F4   , KC_HOME , KC_END  , KC_UNDS , KC_PLUS , KC_LCBR , KC_RCBR , KC_PIPE ,
